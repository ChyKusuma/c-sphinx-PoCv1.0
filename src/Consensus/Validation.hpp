...
namespace SPHINXChainConsensus {
    ...
    // Function to calculate the minimum size of a witness commitment structure
    size_t GetMinimumWitnessCommitmentSize() {
        // The minimum size of a witness commitment structure is 38 bytes
        return 38;
    }
